...
"Signal" means a read pileup profile froma a bam file or score from a bigwig file.
...
"Features" are intervals provided in one of several ways. In this example we load a bed file to a GRanges and use that.  Other alterntives are various peak call files.
...
```{r call chiptsne}
ct = ChIPtSNE(features_config = cfg_features, signal_config = cfg_signal)
